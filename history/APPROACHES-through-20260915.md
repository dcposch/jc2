...
The September15 [scaling discriminator](notes.md#2026-09-15-0704-utc--smooth-graph-degeneration-does-not-force-normality)
is MANUAL/PRODUCER-CHECKED, UNPROMOTED: a suitable finite canonical graph
does scale to a literal smooth A2 central fiber, with t-saturation and
globally finite unramified normalization. This does NOT force normality
of the nonzero fibers; a scaled nodal graph shows that bad points can
escape to infinity. The control drops constant Jacobian and canonical
compatibility, so actual-source normality and JC2 remain open. No Rees,
node/control family or graph-parameter successor is selected.
