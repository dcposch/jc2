#!/bin/bash
# ROOT-authorized metadata only on the exact new contact worker.
set -euo pipefail
test "$(uname -s)" = Linux
...
test ! -e /opt/jc2-contact-gram-20260910T2110
test ! -e /run/jc2-contact-gram-20260910T2110
test ! -e /var/lib/jc2-contact-gram-20260910T2110
test ! -e /home/ubuntu/jc2-contact-gram-20260910T2110
install -d -m 0755 /home/ubuntu/jc2-contact-gram-20260910T2110 /home/ubuntu/jc2-contact-gram-20260910T2110/stage
