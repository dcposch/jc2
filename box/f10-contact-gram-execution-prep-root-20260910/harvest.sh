...
test "$(wc -l < terminal-pin-recheck.log)" = 309
...
sha256sum /home/ubuntu/jc2-contact-gram-20260910T2110/evidence.tar.gz /var/lib/jc2-contact-gram-20260910T2110/custody/CUSTODY.json terminal-pin-recheck.log native-postcheck.log native-post.stdout native-post.stderr
