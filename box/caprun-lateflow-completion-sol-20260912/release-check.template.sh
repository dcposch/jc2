...
jc2_unit='JC2_REMOTE_UNIT_PLACEHOLDER'; jc2_cgroup='JC2_REMOTE_CGROUP_PLACEHOLDER'; jc2_base='JC2_REMOTE_BASE_PLACEHOLDER'; jc2_stage='JC2_REMOTE_STAGE_PLACEHOLDER'; jc2_stop='JC2_EARLIEST_ORIGINAL_STOP_EPOCH_PLACEHOLDER'; jc2_fifo='JC2_REMOTE_FIFO_PLACEHOLDER'
...
for jc2_ns in pid mnt cgroup user; do test "$(readlink /proc/$$/ns/$jc2_ns)" = "$(readlink /proc/$jc2_pid/ns/$jc2_ns)"; done
...
exec 'JC2_REMOTE_FIFO_WRITER_PATH_PLACEHOLDER' ROOT_RELEASE_EXACT_PREFLIGHT9_ONLY
