...
def local_certificate_path(value,result_path):
    ...
    assert path.exists(),('certificate missing',value)
    return path.resolve()
...
def main():
    ...
    p.add_argument('--jacobian-method',choices=['direct','factored'],default='direct');a=p.parse_args()
