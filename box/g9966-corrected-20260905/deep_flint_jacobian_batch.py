...
def jacobian_bands(h,C2,C3,outer,cutoff,source,first_band=0,progress=None):
...
def jacobian_band(h,C2,C3,outer,cutoff,source,progress=None):
    result,meta=jacobian_bands(h,C2,C3,outer,cutoff,source,first_band=cutoff,progress=progress)
