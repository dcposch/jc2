...
sys.path.insert(0,'/home/ubuntu/jc2/box/t3-residue-20260906/prior'); sys.path.insert(0,'/home/ubuntu/jc2/box/t3-residue-20260906')
from exact_contact import tower
import sibling_tower3 as S
rows={json.loads(l)['row_id']: json.loads(l) for l in open('/tmp/jc2-lane.slTSed/inputs/roster.jsonl')}
