...
report=ROOT/'xmodel/d125-exceptional-tuned-discriminator-astra-20260907.md'
...
receipt={'status':'TERMINAL','owner':'/root/nonemptiness_certificate','custody_transfer':'ROOT read-only review',
         ...
         'new_claim':'PROVISIONAL: no finite tuned exceptional-center arc with alpha0 nonzero',
         'not_claimed':['pure exceptional center exclusion','existence of degeneration','guarded source emptiness','JC2'],
