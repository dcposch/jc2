...
test "$(tr -d '\n' < /sys/class/dmi/id/board_asset_tag)" = i-0ffb0b24da98f32a8
...
for jc2_path in /usr/bin/python3 /usr/bin/python3.12 /usr/bin/setpriv /bin/ps /usr/bin/ps /usr/lib/python3.12 /etc/ld.so.cache /usr/bin/env /usr/bin/systemctl /opt/jc2-mixed-20260912/science /opt/jc2-mixed-20260912/runtime /opt/jc2-mixed-20260912/lib; do
