...
int main(int argc, char **argv)
{
    ...
    if (!strcmp(argv[1], "overflow")) msolve_input_array(SIZE_MAX, 2, 0);
    ...
    else if (!strcmp(argv[1], "negative-index")) msolve_input_exponent_offset(-1, 600);
        ...
        need(msolve_input_exponent_offset(11299179,600)==UINT64_C(6779507400), "last-term import offset");
        need(msolve_input_exponent_offset(7158279,600)==UINT64_C(4294967400), "first wrapped import offset");
        need((uint32_t)((uint32_t)600*(int32_t)7158279)==104, "old import wrap negative control");
