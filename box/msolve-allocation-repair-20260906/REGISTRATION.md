...
16 GiB; import-offset rebuild 300 s / 16 GiB; tiny boundary + unit/proper
controls 300 s / 16 GiB. At most 1200 s
...
The test pool includes a 60 s correction replay after a subsecond completed
reader mismatch: it uses the remaining original 300 s test allocation, not
an additional arithmetic budget. Both transcripts are retained. No engine
source change occurred after the import-offset rebuild.
