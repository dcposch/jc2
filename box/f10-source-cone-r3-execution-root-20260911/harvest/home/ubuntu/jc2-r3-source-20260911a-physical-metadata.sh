#!/bin/bash
# ROOT-authorized metadata only on the exact future r3 worker (ROOT release).
set -euo pipefail
...
test ! -e /opt/jc2-r3-source-20260911a
test ! -e /run/jc2-r3-source-20260911a
test ! -e /var/lib/jc2-r3-source-20260911a
test ! -e /home/ubuntu/jc2-r3-source-20260911a
install -d -m 0755 /home/ubuntu/jc2-r3-source-20260911a /home/ubuntu/jc2-r3-source-20260911a/stage
