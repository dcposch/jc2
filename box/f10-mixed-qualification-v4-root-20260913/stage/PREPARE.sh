...
task_instance=i-0404e5972feacb9ba
task_stop='2026-09-13 01:42:00 UTC'
task_term='2026-09-13 01:41:55 UTC'
...
test "$(sha256sum "$task_stage/native-metadata.actual.sh" | cut -d' ' -f1)" = b02e77d1d88d5e6b4dd2716766e655ea5c0ed152d41c07358b2395629bee388e
test "$(sha256sum "$task_stage/inspect_native.py" | cut -d' ' -f1)" = a82e8e8906512ea8aac53b4bbc15a31943ea275e34fcf21a13ac86182172744a
test "$(sha256sum "$task_stage/inspect_imports.py" | cut -d' ' -f1)" = 40303cffd88956bc9d8d63039f8e1e6a03da5c73a51305915744f29a775448e6
