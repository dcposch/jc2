...
test "$(date -u +%s)" -lt "$(date -ud '2026-09-11T12:27:45+00:00' +%s)"
jc2_base=/opt/jc2-closedchild-preflight9-20260911b
jc2_stage=/home/ubuntu/jc2-closedchild-preflight9-20260911b/stage
jc2_unit=jc2-closedchild-preflight9-20260911b.service
jc2_cgroup=/sys/fs/cgroup/system.slice/$jc2_unit
jc2_holder=32389
jc2_start=73194
jc2_invocation=ac02f213754c46888489c54d5cb3e60a
jc2_final="$jc2_base/metadata/ROOT-REGISTRATION.json"
[[ "$jc2_holder" =~ ^[1-9][0-9]*$ ]]
cd "$jc2_stage"
test "$(sha256sum FINAL-INSTALL-INPUTS.sha256 | cut -d ' ' -f 1)" = 'd90196456531bdf917098c84a84a88861384c220dcff6882a5305bacd48e8943'
sha256sum --strict -c FINAL-INSTALL-INPUTS.sha256
test "$(sha256sum ROOT-REGISTRATION.json | cut -d ' ' -f 1)" = '4d0d8475ed7d4aac1e42b70b1c7b4ee0198270ead0c3bb46adb78d7a91153ba3'
test "$(sha256sum ROOT-EXECUTION-CARD.md | cut -d ' ' -f 1)" = 'a92cf2680c8d6aff6044f5376fb1dcfeed87a29c527d55c953d940e39a99f281'
...
test "$(jq -r '.instance_id' ROOT-REGISTRATION.json)" = 'i-07553b89026949246'
test "$(jq -r '.boot_id' ROOT-REGISTRATION.json)" = '55c4b95a-8463-4ec5-9cec-03ef03df544e'
...
test "$(sha256sum "$jc2_final" | cut -d ' ' -f 1)" = '4d0d8475ed7d4aac1e42b70b1c7b4ee0198270ead0c3bb46adb78d7a91153ba3'
