...
test ! -e /opt/jc2-closedchild-preflight9-20260911d
test ! -e /run/jc2-closedchild-preflight9-20260911d
test ! -e /var/lib/jc2-closedchild-preflight9-20260911d
test ! -e /home/ubuntu/jc2-closedchild-preflight9-20260911d
install -d -m 0755 /home/ubuntu/jc2-closedchild-preflight9-20260911d /home/ubuntu/jc2-closedchild-preflight9-20260911d/stage
test ! -e /run/jc2-closedchild-preflight9-20260911d-admission
test ! -L /run/jc2-closedchild-preflight9-20260911d-admission
