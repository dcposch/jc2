...
def execute(args: argparse.Namespace, command: Sequence[str]) -> int:
    ...
    try:
        ...
        process = subprocess.Popen(
            ...
            close_fds=True,
            preexec_fn=cpu_preexec(args.cpu_seconds),
        )
