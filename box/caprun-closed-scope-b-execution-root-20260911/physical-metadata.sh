...
test ! -e /opt/jc2-closedchild-preflight9-20260911b
test ! -e /run/jc2-closedchild-preflight9-20260911b
test ! -e /var/lib/jc2-closedchild-preflight9-20260911b
test ! -e /home/ubuntu/jc2-closedchild-preflight9-20260911b
install -d -m 0755 /home/ubuntu/jc2-closedchild-preflight9-20260911b /home/ubuntu/jc2-closedchild-preflight9-20260911b/stage
test ! -e /run/jc2-closedchild-preflight9-20260911b-admission
test ! -L /run/jc2-closedchild-preflight9-20260911b-admission
