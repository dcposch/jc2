...
test 'ROOT_CREATE_EXACT_NINE_EMPTY_LEAVES' = ROOT_CREATE_EXACT_NINE_EMPTY_LEAVES
test "$(id -u)" = 0
...
test 'ROOT_NO_DELEGATION_MIGRATION_OR_CONCURRENT_WRITER' = ROOT_NO_DELEGATION_MIGRATION_OR_CONCURRENT_WRITER
