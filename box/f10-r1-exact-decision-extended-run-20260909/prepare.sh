...
test ! -e /home/ubuntu/f10-r1-exact-decision-extended-run-20260909
test "$(systemctl --user show jc2-f10-r1-exact-decision-extended-run-20260909.service --property=LoadState --value)" = not-found
mkdir /home/ubuntu/f10-r1-exact-decision-extended-run-20260909
date -u +%Y-%m-%dT%H:%M:%SZ
printf '%s\n' 'PREPARE-PASS: exact worker, pins, exclusive directory; no caller executed'
