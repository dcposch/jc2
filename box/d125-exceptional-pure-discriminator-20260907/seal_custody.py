...
NAMES=[
 ...
 'xmodel/d125-exceptional-center-discriminator-astra-20260907.md',
...
EXPECTED=[
 ...
 '3c9aee528612bd75fb2f77200565a874b9f16baf1a142302df4392c5e94c46d7',
...
report=ROOT/'xmodel/d125-exceptional-pure-discriminator-astra-20260907.md'
...
receipt={'status':'TERMINAL','owner':'/root/nonemptiness_certificate','custody_transfer':'ROOT read-only review',
         ...
         'new_claim':'PROVISIONAL necessary first-contact conditions and a k=0 second-order nilpotent source point',
         'uniform_exclusion':'NO-GAIN/GAP after order 2j',
         'not_claimed':['nonzero-k jet','finite jet extension','pure-center exclusion','guarded emptiness','existence of degeneration','JC2'],
