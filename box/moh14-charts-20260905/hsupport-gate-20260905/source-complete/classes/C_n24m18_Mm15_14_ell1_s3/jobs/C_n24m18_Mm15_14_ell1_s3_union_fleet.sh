#!/bin/bash
# Fleet job for class C_n24m18_Mm15_14_ell1_s3 stem C_n24m18_Mm15_14_ell1_s3_union
# parameter_count=129
...
echo "FLEET_START class=C_n24m18_Mm15_14_ell1_s3 stem=C_n24m18_Mm15_14_ell1_s3_union unknowns=129"
