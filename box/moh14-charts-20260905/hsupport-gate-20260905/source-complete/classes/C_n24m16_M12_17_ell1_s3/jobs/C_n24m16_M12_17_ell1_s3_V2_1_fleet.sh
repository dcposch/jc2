...
echo "FLEET_START class=C_n24m16_M12_17_ell1_s3 stem=C_n24m16_M12_17_ell1_s3_V2_1 unknowns=218"
"$SINGULAR" --cpus=1 --threads=1 --flint-threads=1 -q --no-rc \
    "builders/C_n24m16_M12_17_ell1_s3_V2_1_builder.sing"
python3 "/home/ubuntu/jc2/box/moh14-charts-20260905/sprime3_compiler.py" --mode emit-guided --dest "$HERE" --stem "C_n24m16_M12_17_ell1_s3_V2_1"
