...
echo "FLEET_START class=C_n16m12_M6_13_ell3_s3 stem=C_n16m12_M6_13_ell3_s3_V1_1 unknowns=351"
"$SINGULAR" --cpus=1 --threads=1 --flint-threads=1 -q --no-rc \
    "builders/C_n16m12_M6_13_ell3_s3_V1_1_builder.sing"
python3 "/home/ubuntu/jc2/box/moh14-charts-20260905/sprime3_compiler.py" --mode emit-guided --dest "$HERE" --stem "C_n16m12_M6_13_ell3_s3_V1_1"
