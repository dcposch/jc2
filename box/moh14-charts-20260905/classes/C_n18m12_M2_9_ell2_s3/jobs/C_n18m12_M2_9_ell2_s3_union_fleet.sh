...
echo "FLEET_START class=C_n18m12_M2_9_ell2_s3 stem=C_n18m12_M2_9_ell2_s3_union unknowns=122"
"$SINGULAR" --cpus=1 --threads=1 --flint-threads=1 -q --no-rc \
    "builders/C_n18m12_M2_9_ell2_s3_union_builder.sing"
python3 "/home/ubuntu/jc2/box/moh14-charts-20260905/sprime3_compiler.py" emit-guided --dest "$HERE" --stem "C_n18m12_M2_9_ell2_s3_union"
