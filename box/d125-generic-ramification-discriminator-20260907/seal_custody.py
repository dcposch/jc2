...
ROOT=HERE.parents[1]
REPORT=ROOT/'xmodel/d125-generic-ramification-discriminator-astra-20260907.md'
PINS={
...
data={'schema':'jc2.bounded-desk-custody/v1','status':'TERMINAL','owner':'nonemptiness_certificate',
      ...
      'new_result':'NO-GAIN; explicit mixed-order finite zero-k source jet refutes unrestricted tangent extension',
      'no_dependency_on_unreviewed_m2_theorem_for_countercontrol':True,
      'no_live_peer_or_gate_read':True,'no_AWS_SSH_CAS_full_pair_full_source_solver_shared_edits':True,
      'bytecode_writes_disabled':True,'prior_caches_untouched':True,
