...
**The four direct presentations are fully checked.** Reconstructed77/136 rows come from every native pre-division H_j block;111/129 use their existing completed direct rows. The ordinary-coefficient presentation preserves exactly the completed ideal and all parameter support, by the monic basis argument above.
