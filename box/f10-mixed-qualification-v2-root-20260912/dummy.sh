#!/bin/bash
set -eu
TASK_INSTANCE='i-0e074c341fc759521'; TASK_BOOT='828b454d-d658-4e67-89a8-5c07666d2040'; TASK_HOST='ip-172-30-0-143'
TASK_PID_NS='pid:[4026531836]'; TASK_CGROUP_NS='cgroup:[4026531835]'
TASK_UID='65534'; TASK_GID='65534'; TASK_UNIT='jc2-mixed-v2-dummy-20260912'
TASK_TERM_JOB='jc2-mixed-v2-dummy-term'; TASK_KILL_JOB='jc2-mixed-v2-dummy-kill'
TASK_TERM_AT='2026-09-12 23:23:20 UTC'; TASK_KILL_AT='2026-09-12 23:23:25 UTC'
TASK_MOUNT='/opt/jc2-mixed-dummy-v2-20260912'; TASK_ADMIN="$TASK_MOUNT/admin"; TASK_OUTPUT="$TASK_MOUNT/output"
