...
rec('control_sign_flip_detected', (Jmine - 2*Bch - Jlit) != J0_lift); del Bch
pert = X**8*W**52*G[names[0]]   # perturb the largest row J_8_52 by one term
rec('control_row_perturbation_detected', (Jmine - (Jlit + pert)) != J0_lift)
rec('control_dropped_row_detected', (Jmine - (Jlit - keep_first)) != J0_lift, dropped_row_terms=len(keep_first))
