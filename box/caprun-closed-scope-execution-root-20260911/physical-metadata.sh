...
test ! -e /opt/jc2-closedchild-preflight9-20260911a
test ! -e /run/jc2-closedchild-preflight9-20260911a
test ! -e /var/lib/jc2-closedchild-preflight9-20260911a
test ! -e /home/ubuntu/jc2-closedchild-preflight9-20260911a
install -d -m 0755 /home/ubuntu/jc2-closedchild-preflight9-20260911a /home/ubuntu/jc2-closedchild-preflight9-20260911a/stage
test ! -e /run/jc2-closedchild-preflight9-20260911a-admission
test ! -L /run/jc2-closedchild-preflight9-20260911a-admission
