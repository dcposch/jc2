...
task_instance=i-052458938409563d3
task_stop='2026-09-13 02:05:00 UTC'
task_term='2026-09-13 02:04:55 UTC'
...
test "$(sha256sum "$task_stage/native-metadata.actual.sh" | cut -d' ' -f1)" = d28886fcca11bf5fd1152fe91b5eb741bc1757ea4fa03b3019c48d2ea5c014d1
test "$(sha256sum "$task_stage/inspect_native.py" | cut -d' ' -f1)" = 70f5ee228cea48a7823233b92c714c5d0acda1689e98873dc4db6de87adbe35b
test "$(sha256sum "$task_stage/inspect_imports.py" | cut -d' ' -f1)" = a87b787306f38dbab02302f368148e99a599809fb969c2ab61f5952a360e78c9
