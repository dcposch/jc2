...
ROOT = Path('/home/ubuntu/f10-r1-exact-artifact-validation-v2-20260909')
INSTANCE = 'i-08d2a40f272ee9fa2'
JOB = 'f10-r1-exact-artifact-validation-v2-20260909'
DEADLINE = datetime.datetime(2026,9,9,13,35,tzinfo=datetime.timezone.utc).timestamp()
first_math = None
records = []
...
def run(name, script, trailing, operation='check', wall=30, cpu=25, rss=2147483648, defect=None, mathematical=False):
    ...
    require(not mathematical or returned < hard, 'mathematical return at/after hard cutoff: NONDECISION')
    if defect:
...
def main():
    ...
    require(digest(ROOT/'probe.py')=='02913a1caf8cb5ebe2ec7c404ede0247a1954baee3751af8b2645496f6b6e1a7','probe pin')
    require(digest(ROOT/'precision.py')=='56400dd32f4940a0e77b2da79e9b90792b51588d01f0f1a2fded30efebb0af90','corrected precision pin')
    # Caller self-hash is verified by root's external preflight, not recursively embedded here.
