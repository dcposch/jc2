...
test ! -e /opt/jc2-closedchild-preflight9-20260912a
test ! -e /run/jc2-closedchild-preflight9-20260912a
test ! -e /var/lib/jc2-closedchild-preflight9-20260912a
test ! -e /home/ubuntu/jc2-closedchild-preflight9-20260912a
install -d -m 0755 /home/ubuntu/jc2-closedchild-preflight9-20260912a /home/ubuntu/jc2-closedchild-preflight9-20260912a/stage
test ! -e /run/jc2-closedchild-preflight9-20260912a-admission
test ! -L /run/jc2-closedchild-preflight9-20260912a-admission
