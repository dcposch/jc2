...
def build(meta):
    ...
    return {'schema':'f10-r3-necessary-rows/v1','job_tag':'f10-source-cone-r3-necessary-rows-v1',
...
def main():
    ...
    try:
        ...
        os.unlink(temporary)
    print('FORMED_UNCHECKED_NECESSARY_ROWS_25_NO_SOURCE_OUTCOME')
