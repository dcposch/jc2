...
task_instance=i-0a59ae3233f3774a6
task_stop='2026-09-13 03:48:00 UTC'
task_term='2026-09-13 03:47:55 UTC'
...
test "$(sha256sum "$task_stage/native-metadata.actual.sh" | cut -d' ' -f1)" = 235d4237bed5150fda2b4979e4afd97823e3c5add05c2b11b63050794a341b54
test "$(sha256sum "$task_stage/inspect_native.py" | cut -d' ' -f1)" = f6f1d9789ec41208a115bf03cf815440ca4aeb29966cf98e563fd95111b1adad
test "$(sha256sum "$task_stage/inspect_imports.py" | cut -d' ' -f1)" = ff446ff70e5036ab87e03aa0f672f35b86ffe298eb43ca44a26c1800313574da
