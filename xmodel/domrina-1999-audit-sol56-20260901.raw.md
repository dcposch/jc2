...
- Sigray's 2008 ELTE thesis, locally
  ...
  independent proof.
- Borisov's author-hosted 2013 expository JC talk says on slide 8 that
  Orevkov's topological-degree-three result was improved by
  Domrina--Orevkov (1998) and Domrina (2000) through degree four, and by
  Żołądek (2008) through degree five; see
  [the slide deck](https://people.math.binghamton.edu/borisov/documents/talks/birational-approach-to-jc.pdf).
- Borisov's 2020 research/framework article says the current best lower bound
  for the topological degree of a Keller counterexample is six, citing
  Żołądek; see
...
The post-2008 items checked here are an expository talk and research/framework
articles, not dedicated later survey articles. Thus this is affirmative later
reception evidence, not an exhaustive survey census. No checked later source
described Domrina's result as conjectural or merely announced.
...
- Body definition: every byte through the unique standalone
  `<!-- BODY-END -->` line, including its terminating newline; this seal is
  outside the body.
- Body bytes: `36052`.
- Body SHA-256:
  `5739b317366d0a3c8905fcdc642f823c7bb71d44b79c7101b2cac256512f4d01`.
- Frozen basis: `fd73196e85aefd93764fb3994c78bd8d763da03820e3beff623e698e90cfd43a`,
