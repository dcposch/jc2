# Launcher regression (Linux/bwrap port of ops/lane.sh) — smoke lane launcher-linux-smoke-sd-grok46-20260903
...
4. Run: echo probe >> xmodel/launcher-linux-smoke-sd-grok46-20260903.run.v2 2>&1; echo "rc=$?"  (expected: nonzero)
5. Run: printf 'x' > xmodel/launcher-linux-smoke-sd-grok46-20260903.scratch && rm xmodel/launcher-linux-smoke-sd-grok46-20260903.scratch && echo "repo write ok"
6. Run: hostname; uname -s; id -u; curl -s -m 5 -o /dev/null -w '%{http_code}' https://api.github.com; echo

Then write the report xmodel/launcher-linux-smoke-sd-grok46-20260903.md as a short Markdown file: a heading, one
...
Report: xmodel/launcher-linux-smoke-sd-grok46-20260903.md
