# Hostile review lane (mathematics, decisive): WHOLE-MAJOR-TREE NECESSITY — is Moh's construction really universal over sibling factors; the orbit partition and q-root capacity; the recursion's soundness; the ODE consequence (3.7); the passport inequality (3.8); the recentring rule
...
Your task, hostile, from the page images (refs/moh1983_jram340_
...
Report: xmodel/whole-tree-review-opus5-20260903.md
