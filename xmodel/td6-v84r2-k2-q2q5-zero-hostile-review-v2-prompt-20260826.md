...
The first adapter attempt is delivery-negative: its process vanished after a
CLI header and produced no report.  Do not consume that attempt as evidence.

Write exactly one report:
`xmodel/td6-v84r2-k2-q2q5-zero-hostile-review-v2-20260826.md`; edit no other
