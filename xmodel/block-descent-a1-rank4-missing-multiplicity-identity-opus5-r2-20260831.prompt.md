...
```text
xmodel/block-descent-a1-rank4-missing-multiplicity-identity-opus5-r2-20260831.md
```

Create the report file with a skeleton of section headers as your VERY
FIRST action, before any deep analysis, and append each completed section
as you finish it — a truncated run must still leave your partial
findings on disk. Pace your responses: never produce one enormous
response; work section by section with a file write after each. Keep it under roughly 7,000 words. End its body with a
