...
cd "$aws_root"
sha256sum -c cases/max12_812_order2_square_owner_r1_v15_validator_telemetry_repair_20260826/FREEZE.sha256 > "$aws_job/freeze_check.stdout"
...
printf 'validator=PASS_R1_V15_VALIDATOR_TELEMETRY_REPAIR\n' >> "$validation"
