#!/usr/bin/env python3
"""Hash-pinned r5 tag adapter around the frozen r2 EC2 preflight."""
...
def main() -> None:
    ...
    for lane, data in module.LANES.items():
        old = data["tag"]
        new = old.replace("_r2_20260828T133400Z_", "_r5_20260828T140000Z_")
        if new == old:
            raise SystemExit(f"R5_TAG_TRANSFORM_FAILURE:{lane}")
        data["tag"] = new
    module.main()
