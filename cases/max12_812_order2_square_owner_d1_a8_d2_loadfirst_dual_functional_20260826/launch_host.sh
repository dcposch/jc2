...
sha256sum -c cases/max12_812_order2_square_owner_d1_a8_d2_loadfirst_dual_functional_20260826/FREEZE.sha256 > "$base/prelaunch_freeze.stdout"
nohup bash cases/max12_812_order2_square_owner_d1_a8_d2_loadfirst_dual_functional_20260826/run_aws.sh \
  "$source_root" "$evidence" "$tag" 33554432 "$characteristic" 1800 "$source_sha" \
