...
package=cases/max12_812_order2_exact_square_faber_generic_j_exclusion_20260826
tag="max12_812_order2_faber_generic_j_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"
remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t faber-generic-j.XXXXXX.tar.gz)
