#!/usr/bin/env python3
"""LL1-R3 acceptance tests A1-A5 + hostile mutation battery + A6 source
drift.
...
Run:  python3 test_ll1_r3.py     and     python3 -O test_ll1_r3.py
"""
...
def test_a1():
    ...
    chk(pins == C.SOURCE_PINS
        ...
        "A1: all five source pins verify on the current bytes and match "
        "the compiled book")
