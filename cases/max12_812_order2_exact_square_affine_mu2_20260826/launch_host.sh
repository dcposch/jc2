...
package=cases/max12_812_order2_exact_square_affine_mu2_20260826
tag="max12_812_order2_affine_mu2_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"
remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-mu2.XXXXXX.tar.gz)
