#!/usr/bin/env python3
"""AWS-only coefficientwise Q/F_65521 shadow check for V44R1."""
...
def load_parser():
    ...
    spec = importlib.util.spec_from_file_location("v44r1_cross_parser", PARSER)
...
def main() -> None:
    ...
    if qresult.get("status") != "PASS-ACT-TOT-G20-CUSTODY-V44R1-COMPILER" or presult.get("status") != qresult.get("status"):
        raise RuntimeError("lane status")
    stable_fields = (
    ...
    final = {
        "status": "PASS-ACT-TOT-G20-CUSTODY-V44R1-CROSSLANE-SHADOW",
        "host": platform.node(),
        "prime": PRIME,
    ...
    print("PASS-ACT-TOT-G20-CUSTODY-V44R1-CROSSLANE-SHADOW")
