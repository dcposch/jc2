...
package=cases/max12_812_order2_affine_faber_a_graph_relative_cone_a3_v2_q6_face_20260826
v1=cases/max12_812_order2_affine_faber_a_graph_relative_cone_a3_20260826
support=cases/max12_812_order2_affine_faber_a_graph_relative_multisupport_20260826
tag="max12_812_order2_affine_faber_a_graph_relative_cone_a3_v2_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-graph-relative-cone-a3-v2.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
tar -czf "$tarball" "$package" "$v1/analyze_graph_relative_cone_a3.py" "$support/evidence/Box03/aws_q/run/max12_812_order2_affine_faber_a_graph_relative_multisupport_20260826T164514Z_q.stdout" "$support/evidence/r6d/aws_p65521/run/max12_812_order2_affine_faber_a_graph_relative_multisupport_20260826T164514Z_p65521.stdout"
