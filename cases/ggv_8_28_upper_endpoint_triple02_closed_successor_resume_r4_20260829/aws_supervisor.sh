...
printf '{"schema":"triple02_closed_successor_r4_fault_latches_v1","job_tag":"%s","job_nonce":"%s","containment_mode":"%s","worker_rc":%s,"swap_violation":%s,"whole_timeout":%s,"containment_preflight_failure":%s,"launcher_reap_failure":%s,"systemd_final_fault":%s,"systemd_runtime_fault":%s}\n' \
