#!/usr/bin/env python3
"""Fail-closed EC2 preflight for one exact Fitting component."""
...
def lane(host: str, instance: str, product: str, nproc: int, memory: int, tag: str) -> dict[str, object]:
    return {"host": host, "instance": instance, "product": product,
            "nproc": nproc, "min_mem_gib": memory, "tag": tag}


LANES = {
    "c8": lane("ip-172-30-0-34", "i-02cb2b4a379ffcc64", "r6i.4xlarge", 16, 110,
               "ggv_lambda0_fitting_census_c8_r2_20260828T152000Z_r6a"),
    "q1": lane("ip-172-30-0-106", "i-0f089e64c378f5da3", "r6i.4xlarge", 16, 110,
               "ggv_lambda0_fitting_census_q1_r2_20260828T152000Z_r6b"),
    "p": lane("ip-172-30-0-150", "i-040b7a1c2ed72d4cc", "r6i.4xlarge", 16, 110,
              "ggv_lambda0_fitting_census_p_r2_20260828T152000Z_r6c"),
    "c8_q1": lane("ip-172-30-0-45", "i-07eeaf8ba6f0bc419", "r6i.8xlarge", 32, 220,
                  "ggv_lambda0_fitting_census_c8_q1_r2_20260828T152000Z_r6d"),
    "c8p02": lane("ip-172-30-0-131", "i-0793fef088620f2c1", "r6i.4xlarge", 16, 110,
                  "ggv_lambda0_fitting_census_c8p02_r2_20260828T152000Z_r6e"),
    "q1p02": lane("ip-172-30-0-79", "i-0fdde459d4ab36b95", "r6i.4xlarge", 16, 110,
                  "ggv_lambda0_fitting_census_q1p02_r2_20260828T152000Z_r6f"),
    "q1p03": lane("ip-172-30-0-248", "i-0c73ac7019fe3eef2", "r6i.4xlarge", 16, 110,
                  "ggv_lambda0_fitting_census_q1p03_r2_20260828T152000Z_r6g"),
    "triple02": lane("ip-172-30-0-220", "i-0d71d73e0fe8a8cae", "r6i.4xlarge", 16, 110,
                     "ggv_lambda0_fitting_census_triple02_r2_20260828T152000Z_r6h"),
    "triple03": lane("ip-172-30-0-128", "i-072ccec67b0933088", "r6i.4xlarge", 16, 110,
...
def main() -> None:
    ...
    facts = {
        ...
        "platform": sys.platform, "host": os.uname().nodename,
        ...
        "component": args.component, "run_dir": str(run_dir),
        "mem_available_kib": memory["MemAvailable"],
        "swap_total_kib": memory["SwapTotal"], "swap_free_kib": memory["SwapFree"],
        "disk_available_bytes": disk, "singular": str(singular),
    ...
    checks = {
        ...
        "memory": memory["MemAvailable"] >= int(expected["min_mem_gib"]) * 1024 * 1024,
