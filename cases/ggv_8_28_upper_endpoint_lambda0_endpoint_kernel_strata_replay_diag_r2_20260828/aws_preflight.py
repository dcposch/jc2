#!/usr/bin/env python3
"""Hash-pinned reducer-diagnostic tag adapter around frozen r2 preflight."""
...
def main() -> None:
    ...
    module.LANES["p"]["tag"] = "ggv_lambda0_endpoint_strata_replay_diag_r2_20260828T144500Z_r6a"
    module.main()
