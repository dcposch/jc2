...
package=cases/max12_812_order2_affine_faber_a_halfweight_tau90_v2_20260826
tag="max12_812_order2_affine_faber_a_halfweight_tau90_v2_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-halfweight-tau90-v2.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
tar -czf "$tarball" "$package" cases/max12_812_order2_affine_faber_a_halfweight_tau90_20260826/REGISTRATION.md cases/max12_812_order2_affine_faber_a_halfweight_tau90_20260826/FREEZE.sha256 cases/max12_812_order2_affine_faber_a_halfweight_tau90_20260826/V1_DEPLOYMENT_ERRATUM.md cases/max12_812_order2_affine_faber_a_halfweight_tau90_20260826/compile_halfweight_tau90.py cases/max12_812_order2_affine_faber_a_mixed_sigma45_20260826/compile_sigma45.py cases/max12_812_order2_u2_62_strict_rees_20260825/aws_compile_v2_jsat/run/output/compiled_v2/tails.json
