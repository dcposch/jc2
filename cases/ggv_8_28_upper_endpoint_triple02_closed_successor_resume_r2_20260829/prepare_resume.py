...
# Exact member censuses of the two frozen archives (R2 repair: the R1 prose
# understated both; these are now hard gates, verified against the archives).
R3_ARCHIVE_CENSUS = {
    "member_count": 454, "regular_file_count": 391, "directory_count": 63}
PROPER_OPEN_ARCHIVE_CENSUS = {
    "member_count": 574, "regular_file_count": 490, "directory_count": 84}
...
def main() -> int:
    ...
    if r3_census != R3_ARCHIVE_CENSUS:
        raise SystemExit(f"R3_ARCHIVE_EXACT_CENSUS_DRIFT:{r3_census}")
    ...
    proper_open_extracted = extract_selected(
        ...
        proper_open_census)
    if proper_open_census != PROPER_OPEN_ARCHIVE_CENSUS:
        raise SystemExit(
            f"PROPER_OPEN_ARCHIVE_EXACT_CENSUS_DRIFT:{proper_open_census}")
    ...
    print("R3_ARCHIVE_EXACT_CENSUS=454:391:63")
    print("PROPER_OPEN_ARCHIVE_EXACT_CENSUS=574:490:84")
