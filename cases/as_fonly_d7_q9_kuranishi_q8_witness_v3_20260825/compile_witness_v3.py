#!/usr/bin/env python3
"""Corrected exact left-null certificate emitter for the Q8 transition."""
...
V2 = (ROOT / "cases/as_fonly_d7_q9_kuranishi_q8_witness_v2_20260825"
      / "compile_witness_v2.py")
EXPECTED_V2_SHA = "01804fe319b420025fa4cbc5e4c14ece8d703e1e39d04b694823f463e80801a3"
...
scope = {"__file__": str(V2), "__name__": "__q8_v2_prefix__"}
...
def rref_certificate(A, b):
    ...
    if bad is None:
        ...
        assert transition_rows(q9_vector, witness)[:rows] == [0] * rows
