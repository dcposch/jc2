...
[[ -n "${AWS_RUN_TAG:-}" && "$AWS_RUN_TAG" == td6_v89h8_q13_q14_mod_f_functional_extension_* ]] || exit 95
...
[[ "${TD6_Q_SCOPE:-}" == q13-q14-q16-q24 ]] || exit 91
...
"$PYTHON" replay_v89h8_q13_q14_mod_f_functional_extension.py
