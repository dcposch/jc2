...
package=cases/max12_812_order2_affine_faber_a_graph_relative_cone_a3_20260826
support=cases/max12_812_order2_affine_faber_a_graph_relative_multisupport_20260826
tag="max12_812_order2_affine_faber_a_graph_relative_cone_a3_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-graph-relative-cone-a3.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
