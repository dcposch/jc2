...
cd "$aws_root"
sha256sum -c cases/max12_812_order2_disc_triple_k3_receiver_20260826/FREEZE.sha256 > "$aws_job/freeze_check.stdout"
export JC2_REGISTERED_AWS_LANE="$tag"
ulimit -v "$cap_kib"
set +e
timeout "$compile_timeout" python3 cases/max12_812_order2_disc_triple_k3_receiver_20260826/compile_k3.py \
...
input="$aws_job/compiled/disc_triple_k3_p${characteristic}.sing"
...
printf 'validator=PASS_DISC_TRIPLE_K3_RECEIVER\n' >> "$validation"
