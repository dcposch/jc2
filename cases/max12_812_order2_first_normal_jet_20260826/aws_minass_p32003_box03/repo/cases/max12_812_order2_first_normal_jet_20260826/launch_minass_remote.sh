...
python3 cases/max12_812_order2_first_normal_jet_20260826/compile_minass_bases.py \
  "$aws_job/compiled" --characteristic "$characteristic" \
  > "$aws_job/compiler.stdout" 2> "$aws_job/compiler.stderr"
input="$aws_job/compiled/first_normal_minass_bases_p${characteristic}.sing"
