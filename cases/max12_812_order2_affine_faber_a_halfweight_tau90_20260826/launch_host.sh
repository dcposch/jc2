...
package=cases/max12_812_order2_affine_faber_a_halfweight_tau90_20260826
tag="max12_812_order2_affine_faber_a_halfweight_tau90_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-halfweight-tau90.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
