...
package=cases/max12_812_order2_affine_faber_a_h17_direct_unit_relative_cone_v9_20260826
...
tag="max12_812_order2_affine_faber_a_h17_direct_unit_cone_v9_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-h17-cone-v9.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
