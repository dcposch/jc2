#!/usr/bin/env python3
"""Generate independent exact Singular genus diagnostics for candidate H."""
...
def main() -> None:
    ...
    print(f"poly H={h};")
    print('print("Q8-P127-CANDIDATE-GENUS-DIAGNOSTIC");')
    ...
    if args.mode == "normal":
        ...
        print('print("resultant_w_degree="+string(deg(D,w)));')
        print("poly Ds=gcd(D,diff(D,w));")
        print('print("resultant_derivative_gcd_degree="+string(deg(Ds,w)));')
