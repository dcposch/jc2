...
package=cases/max12_812_order2_affine_faber_k_moving_discriminant_sigma15_20260826
tag="max12_812_order2_affine_faber_k_moving_disc_sigma15_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-k-sigma15.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
