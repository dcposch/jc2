...
readonly EXPECTED_LANE='K00-REES-SANDWICH-EXACT-N-V2-R6B-20260829'
readonly EXPECTED_INSTANCE='i-0f089e64c378f5da3'
readonly EXPECTED_MANIFEST='214df908cf7de2466e0f35f35ed8324574e88ea0057b022d6da37b919b5778eb'
readonly META='K00-REES-SANDWICH-V2.meta'
...
readonly NEG='K00-REES-V2-UNDEFINED-REGRESSION'
readonly SEARCH='K00-REES-V2-EXACT-SEARCH'
readonly INITIAL='K00-REES-V2-INITIAL-STRICTNESS'
for output in \
  "$META" \
