...
tag="max12_812_order2_p0_total_rees_t_cs_rho_unit_v18_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t p0-total-rees-t-cs-rho-unit-v18.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
