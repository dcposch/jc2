#!/usr/bin/env python3
"""Fail-closed validator for the syntax-repaired V18R1 chart test."""
...
def main() -> None:
    ...
    if (
        compiler.get("status") != "PASS-T-CS-RHO-UNIT-V18R1-COMPILER"
        or compiler.get("repair") != "E12_POLYNOMIAL_PREFIX_IDEAL_COLLISION_ONLY"
    ...
    if (
        ...
        or "ideal E12=" in script_text
        or script_text.count("ideal Prefix12=") != 1
    ):
        raise RuntimeError("script hash or repair sentinel")
    ...
    result = {
        "status": "PASS-T-CS-RHO-UNIT-V18R1",
