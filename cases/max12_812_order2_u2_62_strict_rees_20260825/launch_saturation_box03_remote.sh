...
if [[ $# -ne 4 ]]; then
  echo "usage: launch_saturation_box03_remote.sh AWS_REPO_ROOT AWS_RUN_DIRECTORY REGISTERED_TAG STRICT_REES_SING" >&2
  exit 125
fi
...
exec bash \
  "$aws_root/cases/max12_812_order2_u2_62_strict_rees_20260825/run_saturation_box03_aws.sh" \
