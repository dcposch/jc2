...
[[ -n "${AWS_RUN_TAG:-}" && "$AWS_RUN_TAG" == td6_v89h10q_allq_transported_nilpotence_quick_* ]] || exit 95
...
sha256sum -c SOURCE_QUICK.sha256
sha256sum -c PAYLOAD_CLOSURE.sha256
"$PYTHON" replay_v89h10q_allq_transported_nilpotence_quick.py
