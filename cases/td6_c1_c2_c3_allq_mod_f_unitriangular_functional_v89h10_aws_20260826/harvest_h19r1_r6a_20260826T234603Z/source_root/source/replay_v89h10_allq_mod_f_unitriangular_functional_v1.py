...
def main():
    ...
    assert os.environ.get("AWS_RUN_TAG", "").startswith(
        "td6_v89h10_allq_mod_f_unitriangular_functional_"
    )
    print("producer=TD6-V89H10-ALLQ-MOD-F-UNITRIANGULAR-FUNCTIONAL")
    ...
    if inverse_B is None:
        ...
        print("TD6-V89H10-ALLQ-MOD-F-UNITRIANGULAR-FUNCTIONAL NONNILPOTENT-PASS")
    ...
    print("TD6-V89H10-ALLQ-MOD-F-UNITRIANGULAR-FUNCTIONAL PASS")
    v85.restore_base_qd_state()
