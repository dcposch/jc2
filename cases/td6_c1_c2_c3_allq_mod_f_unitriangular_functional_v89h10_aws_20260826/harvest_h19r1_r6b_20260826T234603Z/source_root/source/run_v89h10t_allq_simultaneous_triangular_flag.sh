...
[[ -n "${AWS_RUN_TAG:-}" && "$AWS_RUN_TAG" == td6_v89h10t_allq_simultaneous_triangular_flag_* ]] || exit 95
...
sha256sum -c SOURCE_FLAG.sha256
sha256sum -c PAYLOAD_CLOSURE.sha256
"$PYTHON" replay_v89h10t_allq_simultaneous_triangular_flag.py
