#!/usr/bin/env python3
"""Canonical exact raw full-beta genuine-P12 / staged-N13 discriminator.
...
# V39's inherited digest helper hashed repr(E3), which includes process object
# addresses.  Override every imported stage reporter before calculation.
...
def main():
    ...
    print("TD6-A3-Q2-FULL-P12-N13-UNIT-RAW-CANONICAL PASS")
