...
cd "$aws_root"
sha256sum -c cases/max12_812_order2_square_load_ladder_20260826/FREEZE.sha256 \
...
input="$aws_job/compiled/square_load_ladder_${label}.sing"
...
for required in \
  'SQUARE_LADDER_SOURCE_HASHES=PASS' \
  'SQUARE_LADDER_GRADE4_DIVISIBLE=1' \
  'SQUARE_LADDER_GRADE4_IDENTITY=1' \
  'SQUARE_LADDER_GRADE4_FORBIDDEN=1' \
  'SQUARE_LADDER_GRADE5_DIVISIBLE=1' \
  'SQUARE_LADDER_GRADE5_IDENTITY=1' \
  'SQUARE_LADDER_GRADE5_FORBIDDEN=1' \
  'SQUARE_LADDER_GRADE4_RAD_IN_EXPECTED=1' \
  'SQUARE_LADDER_GRADE4_EXPECTED_IN_RAD=1' \
  'SQUARE_LADDER_GRADE5_RAD_IN_EXPECTED=1' \
  'SQUARE_LADDER_GRADE5_EXPECTED_IN_RAD=1' \
  'SQUARE_LADDER_ENDPOINT=PASS_SOURCE_GRADES4_5_AND_RADICALS'
do
...
printf 'validator=PASS_SQUARE_LOAD_LADDER\n' >> "$validation"
