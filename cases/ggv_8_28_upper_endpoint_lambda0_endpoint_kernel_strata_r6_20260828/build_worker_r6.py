#!/usr/bin/env python3
"""Materialize r6 worker with the exact runtime compiler path."""
...
EXPECTED_R6_WORKER_SHA256 = "e6f3ee2772bb3f6eb3d362c134769fc179414b2d7833f9174e1ad41949e31706"
R2_NAME = "ggv_8_28_upper_endpoint_lambda0_endpoint_kernel_strata_r2_20260828"
R6_NAME = "ggv_8_28_upper_endpoint_lambda0_endpoint_kernel_strata_r6_20260828"
...
def main() -> None:
    ...
    new_case = f'compiler_case="$job_dir/runtime/compiler_r6_case"\ncase_dir="$source_root/{R6_NAME}"'
    ...
    result = result.replace('$case_dir/selfcheck_strata.py', '$case_dir/selfcheck_strata_r6.py')
    actual = sha_text(result)
    if EXPECTED_R6_WORKER_SHA256 != "TO_BE_FROZEN" and actual != EXPECTED_R6_WORKER_SHA256:
        raise SystemExit(f"R6_WORKER_HASH_DISAGREEMENT:{actual}")
    args.output.write_text(result)
    print(f"R2_WORKER_SHA256={R2_WORKER_SHA256}")
    print(f"R6_WORKER_SHA256={actual}")
    print("R6_WORKER_NARROW_TRANSFORM_PASS")
