...
cd "$aws_root"
sha256sum -c cases/max12_812_order2_square_owner_d1_a9_k60_zero_grade30_c2_obstruction_20260826/FREEZE.sha256 > "$aws_job/freeze_check.stdout"
export JC2_REGISTERED_AWS_LANE="$tag"
ulimit -v "$cap_kib"
set +e
timeout "$compile_timeout" python3 cases/max12_812_order2_square_owner_d1_a9_k60_zero_grade30_c2_obstruction_20260826/compile_grade30_c2.py "$aws_job/compiled" --characteristic "$characteristic" > "$aws_job/compiler.stdout" 2> "$aws_job/compiler.stderr"
compiler_rc=$?
set -e
...
input="$aws_job/compiled/square_d1_a9_k60_zero_grade30_c2_${label}.sing"
sha256sum "$input" "$aws_job/compiled/result.json" "$aws_job/compiled/parent_collision_v2_result.json" "$aws_job/compiled/parent_v1_collision_result.json" "$aws_job/compiled/parent_v2_result.json" "$aws_job/compiled/parent_v1_result.json" "$aws_job/compiled/parent_v3_result.json" > "$aws_job/compiled.sha256"
set +e
...
for required in \
  ...
  'D1A9_VK60_GRADE28_29_ENDPOINT=PASS_TWO_NONEMPTY_STRATA_ROUTE_GRADE30' \
  'D1A9_G30_PARENT_COLLISION_V2_REPLAY=1' \
  'D1A9_G30_C2_HAND_INVARIANT=1' \
  'D1A9_G30_FULL_COMPACT_IDEAL_EQUALITY=1' \
  'D1A9_G30_DELAYED_AND_TERMINAL_CUSTODY=1' \
  'D1A9_G30_DK601_CORE_RELATIONS=1' \
  'D1A9_G30_DK601_EXACT_CONTACT_UNIT=1' \
  'D1A9_G30_VK601_CUBIC_NILPOTENCE=1' \
  'D1A9_G30_VK601_EXACT_CONTACT_UNIT=1' \
  'D1A9_G30_CHEBYSHEV_PELL_CONTROL=1' \
  'D1A9_G30_ENDPOINT=PASS_EMPTY_BOTH_K601_STRATA'; do
...
printf 'validator=PASS_D1_A9_VK60_GRADE30_C2_EMPTY_BOTH_STRATA\n' >> "$validation"
