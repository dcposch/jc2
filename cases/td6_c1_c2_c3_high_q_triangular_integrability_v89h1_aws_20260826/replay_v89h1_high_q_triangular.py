#!/usr/bin/env python3
"""Exact high-q FIRST triangularity and finite-P12 integrability diagnostic."""
...
def main():
    ...
    assert os.environ.get("AWS_RUN_TAG", "").startswith("td6_v89h1_high_q_")
    print("producer=TD6-V89H1-HIGH-Q-TRIANGULAR-INTEGRABILITY")
    ...
    exact_text = "\n".join(exact_lines) + "\n"
    exact_path = outdir / "HIGH_Q_TRIANGULAR_EXACT_RESULT.txt"
    ...
    print(f"high_q_simultaneous_collapse={str(collapse).lower()}")
    ...
    print(f"TD6-V89H1-HIGH-Q-TRIANGULAR-{banner} DIAGNOSTIC-PASS")
    v85.restore_base_qd_state()
