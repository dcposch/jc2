...
package=cases/max12_812_order2_affine_faber_a_graph_relative_multisupport_20260826
tag="max12_812_order2_affine_faber_a_graph_relative_multisupport_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-graph-relative-multisupport.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
tar -czf "$tarball" "$package" cases/max12_812_order2_affine_faber_a_full_k_multisupport_20260826/compile_full_k_multisupport.py cases/max12_812_order2_affine_faber_a_loaded_kernel_sigma45_20260826/compile_loaded_kernel.py cases/max12_812_order2_affine_faber_a_mixed_sigma45_20260826/compile_sigma45.py cases/max12_812_order2_u2_62_strict_rees_20260825/aws_compile_v2_jsat/run/output/compiled_v2/tails.json xmodel/max12-812-order2-affine-faber-a-formal-weighted-h3-h5-hostile-review-grok-20260826.md xmodel/max12-812-order2-affine-faber-a-load-graph-functional-cancellation-20260826.md
