...
# V34's legacy digest used repr(E3), but E3 intentionally has no __repr__;
# that made otherwise equal certificates hash process memory addresses.  All
# imported stage reporters and every local certificate use this serializer.
...
def main():
    ...
    for name, value in denominators.items():
        assert b.factors_only_allowed(value), (name, value.factor())
    ...
    print("all_denominator_radicals_subset_U_H_B3=true")
