...
cd "$aws_root"; sha256sum -c cases/max12_812_order2_square_a_prolongation_owner_v5_ptangent_validator_20260826/FREEZE.sha256 > "$aws_job/freeze_check.stdout"
...
for required in 'SQUARE_APROLONG_SIGMA14_DIVISIBLE=1' 'SQUARE_APROLONG_SIGMA15_DIVISIBLE=1' 'SQUARE_APROLONG_QUOTIENT_IDENTITIES=1' 'SQUARE_APROLONG_FORBIDDEN=1' 'SQUARE_APROL_PTANGENT_G14_ROW_IDENTITIES=1' 'SQUARE_APROL_PTANGENT_G15_ROW_IDENTITIES=1' 'SQUARE_APROL_PTANGENT_G14_MOD_L_GATE=1' 'SQUARE_APROL_PTANGENT_DELTA_MOD_L=1' 'SQUARE_APROL_PTANGENT_DELTA_KILLED_BY_G14=1' 'SQUARE_APROL_PTANGENT_MOVING_SEPARATOR=1' 'SQUARE_APROL_PTANGENT_ENDPOINT=PASS_MOVING_P_SOURCE_ROW_ADDENDUM'; do
...
printf 'validator=PASS_SQUARE_APROL_PTANGENT_V5\n' >> "$validation"
