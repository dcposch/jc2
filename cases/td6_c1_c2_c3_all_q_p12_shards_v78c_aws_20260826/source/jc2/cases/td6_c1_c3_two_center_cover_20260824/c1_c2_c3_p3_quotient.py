...
Modes are `p3`, `b16`, `bneg2`, and `bq`; the last three are the exact raw
...
assert COMPONENT in {"p3", "b16", "bneg2", "bq"}
...
def main():
    ...
    center = (X_CURVE * U_CURVE**2, V_CURVE, U_CURVE)
    print(
        "center_stratum=C=XU^2, V^2=YU^3 over exact component function field"
    )
    r.fb.CENTER = center
