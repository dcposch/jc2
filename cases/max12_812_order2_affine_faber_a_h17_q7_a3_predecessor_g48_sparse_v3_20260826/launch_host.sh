...
package=cases/max12_812_order2_affine_faber_a_h17_q7_a3_predecessor_g48_sparse_v3_20260826
...
tag="max12_812_order2_affine_faber_a_h17_q7_a3_g48_sparse_v3_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-h17-q7-g48-sparse-v3.XXXXXX.tar.gz)
tar -czf "$tarball" "$package" "$v2" "$base" "$tails"
