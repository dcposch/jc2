...
cd "$aws_root"
sha256sum -c cases/max12_812_order2_affine_faber_a_h17_q7_a3_predecessor_g48_sparse_v3_20260826/FREEZE.sha256 > "$aws_job/freeze_check.stdout"
export JC2_REGISTERED_AWS_LANE="$tag"; ulimit -v "$cap_kib"
set +e
/usr/bin/time -v timeout "$timeout_seconds" python3 cases/max12_812_order2_affine_faber_a_h17_q7_a3_predecessor_g48_sparse_v3_20260826/emit_h17_q7_g48_v3.py "$aws_job/output" --characteristic "$characteristic" > "$aws_job/run/$tag.stdout" 2> "$aws_job/run/$tag.stderr"
engine_rc=$?
set -e
...
for required in 'A_H17Q7V3_LOWER_ZERO=1' 'A_H17Q7V3_MISSING_TERM_RETAINED=1' 'A_H17Q7V3_ENDPOINT=PASS_COMPLETE_GRADE48_ROWS_DIAGNOSTIC' 'A_H17Q7V3_DONE=1' 'A_H17Q7V3_SCOPE=FIXED_H17_Q7_A3_NORMALIZED_GRAPH_COMPLETE_GRADE48_ROWS_DIAGNOSTIC_ONLY_NO_ELIMINATION_RATIONAL_REGRADING_SOURCE_REES_ORDER2_MAX12_OR_JC2_VERDICT'; do
...
printf 'validator=PASS_A_H17_Q7_A3_G48_DIAGNOSTIC_V3\n' >> "$aws_job/run/$tag.validation"
