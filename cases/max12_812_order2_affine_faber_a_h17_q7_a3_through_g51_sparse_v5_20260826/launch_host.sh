...
package=cases/max12_812_order2_affine_faber_a_h17_q7_a3_through_g51_sparse_v5_20260826
...
tag="max12_812_order2_affine_faber_a_h17_q7_a3_through_g51_v5_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-h17-q7-g51-v5.XXXXXX.tar.gz)
