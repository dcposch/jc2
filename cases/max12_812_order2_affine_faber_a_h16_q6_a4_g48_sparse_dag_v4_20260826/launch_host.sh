...
package=cases/max12_812_order2_affine_faber_a_h16_q6_a4_g48_sparse_dag_v4_20260826
tails=cases/max12_812_order2_u2_62_strict_rees_20260825/aws_compile_v2_jsat/run/output/compiled_v2/tails.json
tag="max12_812_order2_affine_faber_a_h16_q6_a4_g48_sparse_dag_v4_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-h16-g48-sparse-dag-v4.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
tar -czf "$tarball" "$package" "$tails"
