#!/usr/bin/env python3
"""Fail-closed EC2/idle/resource preflight for one Fitting-census lane."""
...
LANES = {
    "base_a": {
        ...
        "tag": "ggv_lambda0_fitting_census_base_a_r1_20260828T150500Z_r6a",
    },
    "base_b": {
        "host": "ip-172-30-0-106", "instance": "i-0f089e64c378f5da3",
        "product": "r6i.4xlarge", "nproc": 16, "min_mem_gib": 110,
        "tag": "ggv_lambda0_fitting_census_base_b_r1_20260828T150500Z_r6b",
    },
    "pair": {
        "host": "ip-172-30-0-150", "instance": "i-040b7a1c2ed72d4cc",
        "product": "r6i.4xlarge", "nproc": 16, "min_mem_gib": 110,
        "tag": "ggv_lambda0_fitting_census_pair_r1_20260828T150500Z_r6c",
    },
    "triple": {
        "host": "ip-172-30-0-45", "instance": "i-07eeaf8ba6f0bc419",
        "product": "r6i.8xlarge", "nproc": 32, "min_mem_gib": 220,
        "tag": "ggv_lambda0_fitting_census_triple_r1_20260828T150500Z_r6d",
    },
}
