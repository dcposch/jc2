...
cd "$aws_root"
sha256sum -c cases/max12_812_order2_affine_faber_a_uniform_h3_h5_grade45_v2_coeffwise_20260826/FREEZE.sha256 > "$aws_job/freeze_check.stdout"
export JC2_REGISTERED_AWS_LANE="$tag"; ulimit -v "$cap_kib"
compiled="$aws_job/compiled"
python3 cases/max12_812_order2_affine_faber_a_uniform_h3_h5_grade45_v2_coeffwise_20260826/compile_uniform_h3_h5_v2.py "$compiled" --characteristic "$characteristic" > "$aws_job/compiler.stdout" 2> "$aws_job/compiler.stderr"
...
for required in 'A_LK45_TCOEFF_CONTROL=1' 'A_LK45_LOWER_ZERO=1' 'A_UH35V2_B_ORDER_GE5=1' 'A_UH35V2_RAW_H3_MOD_S46=1' 'A_UH35V2_RAW_H5_MOD_S46=1' 'A_UH35V2_K_LOWER_ZERO=1' 'A_UH35V2_K45_CERTIFICATE=1' 'A_UH35V2_UNIT=1' 'A_UH35V2_ENDPOINT=PASS_COEFFICIENTWISE_RAW_UNIVERSAL_H3_H5_AND_LOCALIZED_UNIT' 'A_UH35V2_DONE=1' 'A_UH35V2_SCOPE=COMPLETE_SOURCE_COEFFICIENTWISE_MOD_S46_EXACT_MOVING_DISCRIMINANT_ORD_XY_GE6_DELAYED_LOAD_D_P_M_KK_NO_Q_LT6_COVERAGE_TERMINAL_TAYLOR_ORDER2_OR_JC2_VERDICT'; do
...
printf 'validator=PASS_A_UNIFORM_H3_H5_V2_COEFFICIENTWISE_CERTIFICATE\n' >> "$aws_job/run/$tag.validation"
