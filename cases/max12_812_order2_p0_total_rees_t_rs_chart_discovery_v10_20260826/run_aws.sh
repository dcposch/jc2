...
engine_timeout=$9
archive_sha=${10}
package=cases/max12_812_order2_p0_total_rees_t_rs_chart_discovery_v10_20260826
...
ulimit -v "$cap_kib"
set +e
timeout "$compile_timeout" python3 "$package/compile_chart_discovery_v10.py" \
...
set +e
python3 "$package/validate_chart_discovery_v10.py" --job "$aws_job" \
...
printf 'validator=PASS_T_RS_CHART_DISCOVERY_V10\n' \
