...
sha256sum -c cases/max12_812_order2_square_owner_d1_unique_ac_d23_small_a_support_miner_20260826/FREEZE.sha256 > "$base/prelaunch_freeze.stdout"
nohup bash cases/max12_812_order2_square_owner_d1_unique_ac_d23_small_a_support_miner_20260826/run_aws.sh \
  "$source_root" "$evidence" "$tag" 4194304 "$characteristic" 600 "$source_sha" \
