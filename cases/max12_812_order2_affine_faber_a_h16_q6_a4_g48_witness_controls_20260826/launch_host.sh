...
package=cases/max12_812_order2_affine_faber_a_h16_q6_a4_g48_witness_controls_20260826
...
tag="max12_812_order2_affine_faber_a_g48w_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-g48w.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
