...
sha256sum -c cases/max12_812_order2_square_owner_d1_a8d3_connection_rankjump_20260826/FREEZE.sha256 > "$base/prelaunch_freeze.stdout"
nohup bash cases/max12_812_order2_square_owner_d1_a8d3_connection_rankjump_20260826/run_aws.sh \
  "$source_root" "$evidence" "$tag" "$characteristic" 600 2097152 "$source_sha" \
