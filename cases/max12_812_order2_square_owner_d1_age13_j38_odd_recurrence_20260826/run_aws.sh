...
cd "$aws_root"
sha256sum -c cases/max12_812_order2_square_owner_d1_age13_j38_odd_recurrence_20260826/FREEZE.sha256 > "$aws_job/freeze_check.stdout"
export JC2_REGISTERED_AWS_LANE="$tag"
ulimit -v "$cap_kib"
set +e
timeout "$compile_timeout" python3 cases/max12_812_order2_square_owner_d1_age13_j38_odd_recurrence_20260826/compile_age13_j38.py "$aws_job/compiled" --characteristic "$characteristic" > "$aws_job/compiler.stdout" 2> "$aws_job/compiler.stderr"
compiler_rc=$?
set -e
...
input="$aws_job/compiled/square_d1_age13_j38_odd_recurrence_${label}.sing"
...
for required in \
  'D1J38_SOURCE_HASHES=PASS' \
  'D1J38_ODD_RECURRENCE_DIVISIBLE_G38=1' \
  'D1J38_GRADE38_COEFFICIENT_MINUS_J_OVER_4=1' \
  'D1J38_RECURRENCE_MOD_G39=1' \
  'D1J38_EXACT_J_CONTACT_UNIT=1' \
  'D1J38_SYMBOLIC_THETA_ETA_SAFE=1' \
  'D1J38_A12_NEGCTRL_DIVISIBLE_G38=1' \
  'D1J38_A12_K2C_TRIPLE_POLE_BREAKS=1' \
  'D1J38_CHEBYSHEV_PELL_CONTROL=1' \
  'D1J38_ENDPOINT=PASS_EMPTY_UNIFORM_A_GE_13'; do
...
printf 'validator=PASS_D1_AGE13_J38_ODD_RECURRENCE\n' >> "$validation"
