...
package=cases/max12_812_order2_affine_faber_a_mixed_sigma45_20260826
tag="max12_812_order2_affine_faber_a_mixed_sigma45_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-sigma45.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
