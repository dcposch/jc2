...
MEMBERS = [
    ...
    CASE_REL + "/OPERATIONAL_SOURCE_V3.sha256",
    CASE_REL + "/PIPELINE_MANIFEST_V3.json",
    CASE_REL + "/aws_preflight_v3.py",
    CASE_REL + "/job_contract_v3.py",
    CASE_REL + "/run_conditional_pipeline_aws_v3.sh",
    CASE_REL + "/selected_rows_v3.py",
...
CENSUS_REL = "jc2/" + CASE_REL + "/SOURCE_ARCHIVE_MANIFEST_V3.sha256"
ARCHIVE = HERE / "d43_v3_source.tar.gz"
...
def main() -> int:
    ...
    try:
        ...
        shutil.copyfile(census, HERE / "SOURCE_ARCHIVE_MANIFEST_V3.sha256")
