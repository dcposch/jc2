#!/usr/bin/env python3
"""Exact a00pp D43 source-row producer, revision 3.

The mathematical payload is revision 2 unchanged: HW1=h*W1 and HW2=h*W2 are
...
Revision 3 repairs the fail-closed operational contract found deficient by
...
if sys.flags.optimize:
    raise RuntimeError(
        "OPTIMIZED_PYTHON_REFUSED_FAIL_CLOSED: jc2 d43 v3 producer must run "
...
MANIFEST_SCHEMA = "jc2.d43.a00pp-exact-source-manifest.v3"
