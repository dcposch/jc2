...
sha256sum -c cases/max12_812_order2_square_owner_d1_tied_a3c3r2_c2_maxpole2_20260826/FREEZE.sha256 > "$base/prelaunch_freeze.stdout"
nohup bash cases/max12_812_order2_square_owner_d1_tied_a3c3r2_c2_maxpole2_20260826/run_aws.sh \
