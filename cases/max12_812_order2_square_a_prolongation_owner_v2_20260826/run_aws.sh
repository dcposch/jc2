...
cd "$aws_root"
sha256sum -c cases/max12_812_order2_square_a_prolongation_owner_v2_20260826/FREEZE.sha256 \
...
for required in \
  ...
  'SQUARE_APROLONG_NUM15_MOD_L_EQUALS_MINUS_A_CUBED=1' \
...
printf 'validator=PASS_SQUARE_APROLONG\n' >> "$validation"
