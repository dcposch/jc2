...
cd "$aws_root"
sha256sum -c cases/max12_812_order2_p0_cusp_g10_g11_20260826/FREEZE.sha256 \
...
input="$aws_job/compiled/p0_cusp_g10_g11_${label}.sing"
...
for required in \
  ...
  P0_CUSP_COEFFICIENT_EXTRACTOR_CONTROL=1 \
  P0_CUSP_G10_DIVISIBLE=1 \
  P0_CUSP_G11_DIVISIBLE=1 \
  P0_CUSP_QUOTIENT_IDENTITIES=1 \
  P0_CUSP_FORBIDDEN_LATER_VARIABLES=1 \
  P0_CUSP_G10_ANALYTIC_ROWS=1 \
  P0_CUSP_G11_ANALYTIC_ROWS=1 \
  P0_CUSP_G10_LITERAL_RAW_ROWS=1 \
  P0_CUSP_RAW_C0_LOCALIZATION_IDENTITY=1 \
  P0_CUSP_NORMALIZATION_AND_INVERSE_IDENTITIES=1 \
  P0_CUSP_NORMALIZED_G10_ZERO=1 \
  P0_CUSP_G11_FOUR_UNIT_PIVOTS=1 \
  P0_CUSP_G11_HIGH_ROWS_ZERO=1 \
...
printf 'validator=PASS_P0_CUSP_G10_G11\n' >> "$validation"
