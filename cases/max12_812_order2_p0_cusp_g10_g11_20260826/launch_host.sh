...
package=cases/max12_812_order2_p0_cusp_g10_g11_20260826
tag="max12_812_order2_p0_cusp_g10_g11_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"
remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t p0-cusp-g10-g11.XXXXXX.tar.gz)
