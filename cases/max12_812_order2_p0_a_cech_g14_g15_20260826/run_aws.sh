...
cd "$aws_root"
sha256sum -c cases/max12_812_order2_p0_a_cech_g14_g15_20260826/FREEZE.sha256 \
...
input="$aws_job/compiled/p0_a_cech_${label}.sing"
...
for required in \
  'SQUARE_APROLONG_SOURCE_HASHES=PASS' \
  'SQUARE_APROLONG_SIGMA14_DIVISIBLE=1' \
  'SQUARE_APROLONG_SIGMA15_DIVISIBLE=1' \
  'SQUARE_APROLONG_QUOTIENT_IDENTITIES=1' \
  'SQUARE_APROLONG_FORBIDDEN=1' \
  'SQUARE_APROLONG_G14_ROW_IDENTITIES=1' \
  'SQUARE_APROLONG_G15_ROW_IDENTITIES=1' \
  'P0_A_CECH_FABER_IDENTITY_AT_COLLISION=1' \
  'P0_A_CECH_DA0_G15_ROW6_PURE_CUBE=1' \
  'P0_A_CECH_DA1_G14_TRIANGULAR=1' \
  'P0_A_CECH_DA1_G15_ROW3_PURE_CUBE=1' \
  'P0_A_CECH_ENDPOINT=PASS_FIXED_P0_RAW_A_CHARTS'
do
...
printf 'validator=PASS_P0_A_CECH_G14_G15\n' >> "$validation"
