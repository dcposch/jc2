#!/usr/bin/env python3
"""Fail-closed live EC2, lease, and immutable-source preflight for D43 v4.

Revision 4 removes every production ``assert`` (all checks are explicit and
...
if sys.flags.optimize:
    raise RuntimeError(
        "OPTIMIZED_PYTHON_REFUSED_FAIL_CLOSED: jc2 d43 v4 preflight "
        "must run without -O/-OO/PYTHONOPTIMIZE")

HERE = Path(__file__).resolve().parent
ROOT = HERE.parent.parent
SCHEMA = "jc2.d43.a00pp-exact-source-rows.v4.aws-preflight"
LEASE_SCHEMA = "jc2.d43.a00pp-exact-source-rows.v4.run-lease"
...
def conflicts(own_job_tag: str):
    ...
    tokens = ("build_tails43", "gm_jet2", "selected_rows_v2",
              "selected_rows_v3", "selected_rows_v4", "aws_preflight_v",
              "job_contract_v3", "job_contract_v4",
              "run_conditional_pipeline_aws", "aws_launch_v3",
              "aws_launch_v4", "singular", "msolve", "magma")
...
def main():
    ...
    require(manifest["schema"] == "jc2.d43.a00pp-exact-source-manifest.v4",
