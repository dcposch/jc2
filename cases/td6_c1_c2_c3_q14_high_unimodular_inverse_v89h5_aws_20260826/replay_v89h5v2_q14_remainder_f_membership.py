...
def parse_base_polynomial(text):
    ...
    def evaluate(node):
        ...
        if isinstance(node, ast.Constant):
            ...
            return m.tri.CTX.constant(node.value)
        ...
        if isinstance(node, ast.BinOp):
            ...
            if isinstance(node.op, ast.Div):
                ...
                return left / right.leading_coefficient()
