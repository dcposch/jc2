#!/usr/bin/env python3
"""Deterministic sealer for the D43 `K0` field certificate packet, R3.
...
repaired.  R3 adds a fourth, the Fable 5 R2 source review whose REPAIR-1 this
packet answers.  All four are pinned in ``execution_pins_r3.json`` and checked
by ``SRC_FILE_HASHES``.
"""
...
PACKET_REL = "cases/d43_k0_field_certificate_r3_20260829"
EXTERNAL_MEMBERS = (
