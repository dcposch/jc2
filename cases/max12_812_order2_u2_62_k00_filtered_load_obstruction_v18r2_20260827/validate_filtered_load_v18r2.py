...
def main() -> None:
    ...
    if audit.get("status") != "PASS-K00-FILTERED-LOAD-V18R2-PROVISIONAL-Q-EMITTER" or audit.get("field") != args.field:
    ...
    result = {
        **audit,
        "status": "PASS-K00-FILTERED-LOAD-V18R2-PROVISIONAL-Q-ENDPOINT",
