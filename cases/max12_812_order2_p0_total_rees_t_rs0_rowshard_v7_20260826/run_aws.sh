...
support_package=cases/max12_812_order2_p0_total_rees_t_rs0_rowshard_v6_20260826
...
set +e
python3 "$support_package/prepare_certificate.py" \
...
set +e
python3 "$support_package/finalize_discovery.py" \
...
printf 'validator=PASS_T_RS0_ROW_SHARD_V6_COMPILER_V7_NAVIGATION_ONLY\n' >> "$aws_job/validator.validation"
