#!/usr/bin/env python3
"""Fail-closed aggregate/Merkle certificate for corrected shard outputs."""
...
sums = Counter()
n12_hist, q11_hist = Counter(), Counter()
leaves = []
previous_stop = 0
for index in range(shard_count):
    ...
    assert lines[-1] == "PASS-NEXT-TOP-CARRY-CORRECTED-SHARD"
...
print("PASS-NEXT-TOP-CARRY-CORRECTED-SHARD-AGGREGATE")
