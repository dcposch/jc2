...
r2=cases/max12_812_order2_gate_t_actual_total_g20_custody_v44r2_20260827
...
tag="max12_812_order2_gate_t_actual_total_g20_custody_v44r3_${stamp}_${mode}"
root="/home/ubuntu/jobs/$tag/source"
job="$root/$package/aws_${mode}"
tarball=$(mktemp -t actual-total-g20-v44r3.XXXXXX.tar.gz)
trap 'rm -f "$tarball"' EXIT
COPYFILE_DISABLE=1 tar -czf "$tarball" \
  "$package" "$r2/validate_frozen_v44r1_v44r2.py" "$r2/validate_crosslane_v44r2.py" \
