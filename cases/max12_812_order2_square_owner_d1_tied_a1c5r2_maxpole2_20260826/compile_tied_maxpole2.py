#!/usr/bin/env python3
"""Compile V2 of the exact tied (a,c,r)=(1,5,2) maximal-pole producer; AWS only."""
...
PINS = {
    ...
    HERE / "PREREGISTRATION.md":
        "9deeb51b92d211bb11b57e13e94f316826569ba265b3879970b9e9bd96b70e65",
}
...
def main() -> None:
    ...
    lines = [
        ...
        'print("T15_COMPILER_VERSION=V2_ORDINARY_PART_REMAINDER");',
    ...
    lines += [
        ...
        "-(3/8)*T15_R*T15_A^2;",
        "ideal T15_L2Ideal=std(ideal(T15_L^2));",
        "poly T15_OrdinaryQuotient=(T15_N2Expected-T15_N2)/(T15_L^2);",
        "int T15_common_numerator=(reduce(T15_N2-T15_N2Expected,T15_L2Ideal)==0"
        " && T15_N2+(T15_L^2)*T15_OrdinaryQuotient-T15_N2Expected==0);",
        ...
        'print("T15_ORDINARY_PART_QUOTIENT_RETAINED="+string(T15_common_numerator));',
