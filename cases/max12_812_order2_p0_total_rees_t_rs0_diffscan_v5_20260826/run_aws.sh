...
set +e
timeout "$compile_timeout" python3 "$package/compile_t_rs0_diffscan.py" \
...
input="$aws_job/compiled/t_rs0_diffscan_${label}.sing"
...
printf 'validator=PASS_T_RS0_DIFFSCAN_V5_NAVIGATION_ONLY\n' >> "$aws_job/validator.validation"
