...
def main() -> None:
    ...
    lines += [
        ...
        f"int {prefix}rootfaber=({prefix}PsiPlus-{prefix}NPlus==0 && {prefix}PsiMinus-{prefix}NMinus==0);",
        ...
        f"*{prefix}omitconnection*{prefix}rootfaber*{prefix}rootsquares*{prefix}closedunits*{prefix}omitc2;",
