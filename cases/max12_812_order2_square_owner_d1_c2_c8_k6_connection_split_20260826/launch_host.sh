...
sha256sum -c cases/max12_812_order2_square_owner_d1_c2_c8_k6_connection_split_20260826/FREEZE.sha256 > "$base/prelaunch_freeze.stdout"
nohup bash cases/max12_812_order2_square_owner_d1_c2_c8_k6_connection_split_20260826/run_aws.sh \
  "$source_root" "$evidence" "$tag" "$characteristic" 1800 67108864 "$source_sha" \
