...
package=cases/max12_812_order2_affine_faber_a_h16_q6_a4_g48_odd_series_qring_v3_20260826
...
tag="max12_812_order2_affine_faber_a_h16_q6_a4_g48_odd_qring_v3_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-h16-q6-a4-odd-qring-v3.XXXXXX.tar.gz); trap 'rm -f "$tarball"' EXIT
