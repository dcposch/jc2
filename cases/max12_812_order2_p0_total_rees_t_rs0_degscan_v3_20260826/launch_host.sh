...
package=cases/max12_812_order2_p0_total_rees_t_rs0_degscan_v3_20260826
...
tag="max12_812_order2_p0_total_rees_t_rs0_degscan_v3_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"
remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t p0-total-rees-t-rs0-degscan-v3.XXXXXX.tar.gz)
