#!/usr/bin/env python3
"""AWS-only exact relative-cone analysis of the H17 direct-unit functional, V8."""
...
def main() -> None:
    ...
    if {record["line"] for record in equality_blocks[str(sharp_upper)]} != {"72+(-3)q"}:
    ...
    result = {
        "status": "PASS-A-H17-DIRECT-UNIT-RELATIVE-CONE-V8",
    ...
    print("A_H17_CONE_ENDPOINT=PASS_EXACT_RELATIVE_CONE_V8")
