...
package=cases/max12_812_order2_affine_faber_a_h17_q7_a3_numeric_prolong_v8_20260826
v7=cases/max12_812_order2_affine_faber_a_h17_q7_a3_numeric_prolong_v7_20260826/prolong_h17_q7_numeric_v7.py
...
tag="max12_812_order2_affine_faber_a_h17_q7_a3_numeric_prolong_v8_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"; remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t affine-faber-a-h17-q7-prolong-v8.XXXXXX.tar.gz)
tar -czf "$tarball" "$package" "$v7" "$v2" "$base" "$tails"
