...
sha256sum -c cases/max12_812_order2_square_owner_d1_universal_odd_pole_recurrence_20260826/FREEZE.sha256 > "$base/prelaunch_freeze.stdout"
nohup bash cases/max12_812_order2_square_owner_d1_universal_odd_pole_recurrence_20260826/run_aws.sh \
  "$source_root" "$evidence" "$tag" "$characteristic" 4194304 600 24 \
