...
package=cases/max12_812_order2_p0_cusp_raw_g12_cech_certificate_v2_20260826
tag="max12_812_order2_p0_cusp_raw_g12_cech_v2_${stamp}_${suffix}"
remote_root="/home/ubuntu/jobs/$tag/source"
remote_job="$remote_root/$package/aws_${suffix}"
tarball=$(mktemp -t p0-cusp-raw-g12-cech-v2.XXXXXX.tar.gz)
