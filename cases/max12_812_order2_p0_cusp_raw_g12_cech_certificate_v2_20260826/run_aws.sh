...
cd "$aws_root"
sha256sum -c cases/max12_812_order2_p0_cusp_raw_g12_cech_certificate_v2_20260826/FREEZE.sha256 \
...
input="$aws_job/compiled/p0_cusp_raw_g12_cech_v2_${label}.sing"
...
printf 'validator=PASS_P0_CUSP_RAW_G12_CECH_CERTIFICATE_V2\n' >> "$validation"
