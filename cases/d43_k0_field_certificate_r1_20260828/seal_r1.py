#!/usr/bin/env python3
"""Deterministic sealer for the D43 `K0` field certificate packet, R1.
...
PACKET_REL = "cases/d43_k0_field_certificate_r1_20260828"
EXTERNAL_MEMBERS = (
...
def main(argv=None):
    ...
    if not args.verify:
        (pkt / "SOURCE_ARCHIVE.tar").write_bytes(archive)
        (pkt / "SOURCE_ARCHIVE.tar").chmod(0o444)
