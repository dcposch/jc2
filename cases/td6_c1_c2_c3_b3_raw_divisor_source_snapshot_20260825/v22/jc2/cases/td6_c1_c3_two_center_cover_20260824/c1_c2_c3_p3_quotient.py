...
Modes are `p3`, `b16`, `bneg2`, `bq`, and `b3tq`; the middle three are raw
...
assert COMPONENT in {"p3", "b16", "bneg2", "bq", "b3tq"}
...
def main():
    ...
    if COMPONENT == "b3tq":
        print("B3_parameter_t_quadratic=t^2-4t+2")
