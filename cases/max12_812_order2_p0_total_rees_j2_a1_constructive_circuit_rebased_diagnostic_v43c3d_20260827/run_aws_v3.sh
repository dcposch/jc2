...
package=cases/max12_812_order2_p0_total_rees_j2_a1_constructive_circuit_rebased_diagnostic_v43c3d_20260827
prefix=max12_812_order2_p0_total_rees_j2_a1_constructive_circuit_rebased_v43c3_diagnostic_v43c3d_
if [[ "$tag" != "${prefix}"* ]]; then exit 126; fi
